  ...
  */
	...
	DataGrid.prototype = {
		...
		initTable: function initTable() {
			...
			this.table ? this.ele.replaceChild(table, this.table) : this.ele.appendChild(table);
			this.table = table;
		},
		...
		setTbody: function setTbody(tbody) {
			var table = document.createElement('table');
			table.appendChild(tbody);
		...
		ajaxForData: function ajaxForData(successFn) {
			if (!this.ajax) {
				return false;
			}
			var that = this,
		...
		clickCheckAll: function clickCheckAll(target, e) {
		...
		clickCheckbox: function clickCheckbox(target, e) {
		...
		sortChange: function sortChange(target, e) {
